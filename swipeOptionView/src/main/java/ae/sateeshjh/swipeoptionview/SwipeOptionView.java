...
import ae.sateeshjh.swipeoptionview.androidutils.DimenUtilsKt;
import ae.sateeshjh.swipeoptionview.androidutils.ImageUtilsKt;
import ae.sateeshjh.swipeoptionview.androidutils.anim.AnimatedFloat;

public class SwipeOptionView extends View implements View.OnTouchListener {
    ...
    private SlideOptionListener listener;
    ...
    public SwipeOptionView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public SwipeOptionView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init();
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public SwipeOptionView(Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        super(context, attrs, defStyleAttr, defStyleRes);
        init();
    }

    private void init() {
        handleRadius = ae.sateeshjh.swipeoptionview.androidutils.DimenUtilsKt.dpToPx(12);
        expandedHandleRadius = ae.sateeshjh.swipeoptionview.androidutils.DimenUtilsKt.dpToPx(32);
        selectionRadius = ae.sateeshjh.swipeoptionview.androidutils.DimenUtilsKt.dpToPx(42);
        rippleRadius = DimenUtilsKt.dpToPx(140);
     ...
     */
    public void setListener(SlideOptionListener listener) {
    ...
    public void setLeftIcon(Drawable drawable) {
        setLeftIcon(ae.sateeshjh.swipeoptionview.androidutils.ImageUtilsKt.toBitmap(drawable));
    }
    ...
    public void setRightIcon(Drawable drawable) {
        setRightIcon(ImageUtilsKt.toBitmap(drawable));
    }
